...
(function () {
  ...
  function render(host) {
    ...
    var selected = 0, revision = 0, renderedRevision = -1, pdf = null, zip = null, urls = [], busy = false, alive = true, removed = null, templates = [], timer = null, previewSerial = 0, pageNumber = 1, pageUrl = null;
    ...
    function status(message, error) { if (!alive) return; var node = host.querySelector('[data-status]'); node.textContent = message; node.dataset.error = String(!!error); }
